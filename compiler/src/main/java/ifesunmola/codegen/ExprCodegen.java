...
import ifesunmola.codegen.CodegenUtils.ClassVariable;
import ifesunmola.codegen.CodegenUtils.MethodVariable;
import ifesunmola.lexer.TokenType;
import ifesunmola.parser.exprs.*;
import ifesunmola.parser.exprs.BinaryExpr.*;
...
import static ifesunmola.codegen.CodegenUtils.*;
import static ifesunmola.lexer.TokenType.*;
import static ifesunmola.sanity.EarthType.Base.*;
import static java.lang.constant.ConstantDescs.*;

/// This class simply loads the expression onto the stack, and returns the type
/// of the expression that was loaded
...
class ExprCodegen {
	...
	/// integer or a float, depending on the combination.\ Any operation
	/// involving
	/// a float results in a float.\
	...
	/// Everything except the following are invalid:\ int (+ | -) int = int\ int

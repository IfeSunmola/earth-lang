...
import ifesunmola.parser.stmts.*;

/// Final Step in SanityChecker. Goes through all the statements in the list and
/// exits the program if any of the statements contains expressions that have
/// their type as null.\ Tried using reflection for this but couldn't get it to
/// work :(
